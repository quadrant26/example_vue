<template>
    <div id="article">
        ...
        <div class="content">
            <div class="header articleheader clear"><h2><img :src="articleData.author_face" alt=""/></h2><p>quadrant26</p></div>
		    <div class="cont">
		    	<h3>{{articleData.title}}</h3>
		        <div class="time"><p>{{articleData.time | filterTime}} <span><img src="../assets/img/zan.png" alt=""/></span></p></div>
...
<script>
    export default{
        ...
        methods:{
            getArticle(id){
                var _this = this;
                this.$http.get("http://localhost:8989/src/data/article.data").then(function (res){
                    //console.log(res);
